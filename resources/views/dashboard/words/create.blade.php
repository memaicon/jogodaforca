...
@section('title', 'Nova Palavra')

@section('content')

{!! Form::open(['route' => 'palavras.store', 'method' => 'post', 'class'=>'form-horizontal', 'role'=>'form']) !!}
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('categorie_id') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::select('categorie_id', \App\Models\Categorie::pluck('name', 'id'), null, ['class'=>'form-control']) }}
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group {{ $errors->has('tip_phrase') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::text('tip_phrase', null, ['class' => 'form-control']) }}
                                                </div>
