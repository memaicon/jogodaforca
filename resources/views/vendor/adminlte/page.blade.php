			...
			<ul class="metismenu" id="side-menu">
				...
				<li>
					<a href="{{ route('categorias.index') }}">
						<i class="mdi mdi-playlist-check"></i><span> Gerenciar Categorias </span>
					</a>
				</li>

				<li>
					<a href="{{ route('palavras.index') }}">
						<i class="mdi mdi-playlist-edit"></i><span> Gerenciar Palavras </span>
					</a>
				</li>

				<li>
					<a href="{{ route('users.index') }}">
						<i class="mdi mdi-account"></i><span> Gerenciar Usuários </span>
					</a>
				</li>

				<li>
					<a href="{{ route('ranking.index') }}">
						<i class="mdi mdi-network"></i><span> Gerenciar Ranking </span>
					</a>
				</li>
				{{--
				...
				<li>
					...
					<ul class="nav-second-level" aria-expanded="false">
						...
						@permission('view.menu.aparencia')
						<li><a href="{{ route('appearance') }}">Aparência</a></li>
						@endpermission

						@permission('view.aplicacao')
						<li><a href="{{ route('configs.index') }}">Aplicação</a></li>
						@endpermission
						...
						<li><a href="{{ route('roles.index') }}">Níveis de Acesso</a></li>
						@endif

						@permission('view.permissoes')
						<li><a href="{{ route('permissoes.index') }}">Permissões</a></li>
						@endpermission
					</ul>
				</li>
				@endpermission
...
<script>
	...
	$('.phoneMask').mask(phoneMask, phoneOpt);
